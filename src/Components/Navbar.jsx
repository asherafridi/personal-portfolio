...
const Navbar = () => {
  return (
    <>
      <div className="px-5 bg-neutral-950 min-h-dvh overflow-auto py-4 w-1/6 justify-between items-center">
        ...
        <div className="block w-full text-slate-50 gap-5 text-md items-center mt-10 ">
